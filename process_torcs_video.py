...
def process_video(net, vid_in, vid_out, height, width, frames_count = -1, fps = 25, sub_vgg_mean = True):    
    ...
    while count < total_length:
        print "\r processed " + str(count) + "/" + str(total_length),
    ...
    print '\n'
    vdr.release()
    os.system('ffmpeg -f image2 -r ' + str(fps) + ' -i ' + vid_out + '%05d.png -c:v libx264 -crf 20 ' + vid_out + 'raw.mp4')
